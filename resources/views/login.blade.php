...
<div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row"
      ...
      <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
        <div class="right mx-lg-0 mx-auto">
          ...
          <h3 class="title-text">Masuk Sebagai Admin</h3>
          <p class="caption-text">
            Mohon masuk sebagai admin pengelola
          </p>
          ...
          <form style="margin-top: 1.5rem" action="/login" method="post">
            ...
            <div style="margin-bottom: 1.75rem">
              ...
              <div class="d-flex w-100 div-input">
                ...
                <input class="input-field border-0 @error('email') is-invalid @enderror" type="email" name="email" id="email" placeholder="Your Email Address"
                  autocomplete="on" autofocus required value="{{ old('email') }}"/>
                  @error('email')
