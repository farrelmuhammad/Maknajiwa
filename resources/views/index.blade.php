      ...
      <div>
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div
            ...
            <p class="text-caption-up">Knows Early Your Self</p>
      ...
      <div class="grid-padding text-center">
        <div class="row">
          <div class="col-lg-4 column">
            ...
            <h3 class="icon-title">Pilih Jenis Tes</h3>
            <p class="icon-caption">
              Berbagai kategori tes yang tersedia. Pilih yang sesuai dengan kondisimu saat ini.
            </p>
          </div>
          <div class="col-lg-4 column">
            <div class="icon">
            ...
            <h3 class="icon-title">Kerjakan Tes</h3>
            <p class="icon-caption">
              Pilih jawaban yang sesuai dengan penggambaran kondisimu sebenarnya.<br />
            </p>
          </div>
          <div class="col-lg-4 column">
            <div class="icon">
            ...
            <h3 class="icon-title">Hasil Tes</h3>
            <p class="icon-caption">
              Hasil tes akan muncul beserta solusi setelah mengerjakan tes. dan dalam bentuk card report.<br />
            </p>
          </div>
        </div>
      </div>
			...
			<div class="border-color info-footer">
				...
				<div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
					...
					<nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
						<p style="margin: 0">Copyright © 2021 Dicoding</p>
					</nav>
				</div>
			</div>
		</div> 
