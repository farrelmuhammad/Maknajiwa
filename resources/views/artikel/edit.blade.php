        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('blogartikel.update', $post->id_artikel) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('judul_artikel') is-invalid @enderror"
                                    name="judul_artikel" value="{{ old('judul_artikel', $post->judul_artikel) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('deskripsi') is-invalid @enderror"
                                    name="deskripsi" value="{{ old('deskripsi', $post->deskripsi) }}" required>
                            ...
                            <div class="form-group">
                                <img src="{{$post->gambar}}" id="myImage" width="200px">
                                <input type="file" class="form-control @error('gambar') is-invalid @enderror" 
                                id="pictureInput" name="picture" multiple />
                                <textarea id="code" name="gambar" value="{{$post->gambar}}" style="display: none"></textarea>
